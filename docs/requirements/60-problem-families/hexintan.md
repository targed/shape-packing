# hexintan: Hexagon in Tan

Family: N_hex_in_tan (N hexagons inside a Tan container).

1. Geometry:
- WHEN inner is "hex" and container is "tan" THEN:
...
- WHEN a solution is generated THEN:
  - all hexagons SHALL be inside the Tan.

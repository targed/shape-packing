# octindom: Octagon in Domino

Family: N_oct_in_dom (N octagons inside a domino container).

1. Geometry:
- WHEN inner is "oct" and container is "dom" THEN:
...
- WHEN a solution is generated THEN:
  - all octagons SHALL be inside the domino.

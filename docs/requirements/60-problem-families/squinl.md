# squinl: Square in L-tromino

Family: N_squ_in_L (N squares inside an L-tromino container).

1. Geometry:
- WHEN inner is "squ" and container is "L" THEN:
...
- WHEN a solution is generated THEN:
  - all squares SHALL be inside the L-tromino.

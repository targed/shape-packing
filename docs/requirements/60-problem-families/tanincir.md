# tanincir: Tan in Circle

Family: N_tan_in_CIRCLE (N tans inside a circle container).

1. Geometry:
- WHEN inner is "tan" and container is "CIRCLE" THEN:
...
- WHEN a solution is generated THEN:
  - all tans SHALL be inside the circle.

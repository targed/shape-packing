# penintan: Pentagon in Tan

Family: N_pen_in_tan (N pentagons inside a Tan container).

1. Geometry:
- WHEN inner is "pen" and container is "tan" THEN:
...
- WHEN a solution is generated THEN:
  - all pentagons SHALL be inside the Tan.

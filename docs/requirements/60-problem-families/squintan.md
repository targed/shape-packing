# squintan: Square in Tan

Family: N_squ_in_tan (N squares inside a Tan container).

1. Geometry:
- WHEN inner is "squ" and container is "tan" THEN:
...
- WHEN a solution is generated THEN:
  - all squares SHALL be inside the Tan.

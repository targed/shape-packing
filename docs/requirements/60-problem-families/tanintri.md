# tanintri: Tan in Triangle

Family: N_tan_in_tri (N tans inside a triangle container).

1. Geometry:
- WHEN inner is "tan" and container is "tri" THEN:
...
- WHEN a solution is generated THEN:
  - all tans SHALL be inside the triangle.

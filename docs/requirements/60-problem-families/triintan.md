# triintan: Triangle in Tan

Family: N_tri_in_tan (N triangles inside a Tan container).

1. Geometry:
- WHEN inner is "tri" and container is "tan" THEN:
...
- WHEN a solution is generated THEN:
  - all triangles SHALL be inside the Tan.

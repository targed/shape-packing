# taninoct: Tan in Octagon

Family: N_tan_in_oct (N tans inside an octagon container).

1. Geometry:
- WHEN inner is "tan" and container is "oct" THEN:
...
- WHEN a solution is generated THEN:
  - all tans SHALL be inside the octagon.

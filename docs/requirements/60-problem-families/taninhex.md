# taninhex: Tan in Hexagon

Family: N_tan_in_hex (N tans inside a hexagon container).

1. Geometry:
- WHEN inner is "tan" and container is "hex" THEN:
...
- WHEN a solution is generated THEN:
  - all tans SHALL be inside the hexagon.

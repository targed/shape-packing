# squinhex: Square in Hexagon

Family: N_squ_in_hex (N squares inside a hexagon container).

1. Geometry:
- WHEN inner is "squ" and container is "hex" THEN:
...
- WHEN a solution is generated THEN:
  - all squares SHALL be inside the hexagon.

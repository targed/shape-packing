# squinoct: Square in Octagon

Family: N_squ_in_oct (N squares inside an octagon container).

1. Geometry:
- WHEN inner is "squ" and container is "oct" THEN:
...
- WHEN a solution is generated THEN:
  - all squares SHALL be inside the octagon.

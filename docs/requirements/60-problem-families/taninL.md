# taninL: Tan in L-tromino

Family: N_tan_in_L (N tans inside an L-tromino container).

1. Geometry:
- WHEN inner is "tan" and container is "L" THEN:
...
- WHEN a solution is generated THEN:
  - all tans SHALL be inside the L-tromino.

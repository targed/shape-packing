# octintan: Octagon in Tan

Family: N_oct_in_tan (N octagons inside a Tan container).

1. Geometry:
- WHEN inner is "oct" and container is "tan" THEN:
...
- WHEN a solution is generated THEN:
  - all octagons SHALL be inside the Tan.

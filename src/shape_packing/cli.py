...
def handle_run(args):
    ...
    if os.path.exists(solution_file):
        verify_cmd = [sys.executable, "-m", "scripts.verify_solution", solution_file]
        subprocess.run(verify_cmd)
        
        render_cmd = [sys.executable, "-m", "scripts.render_solution", solution_file, os.path.join(result_dir, "solution.png")]

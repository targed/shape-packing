# Submission Draft: octintri

**To:** Erich Friedman (via packing website)
**Subject:** New packing records for octintri (8 in 3)
**Problem Page:** https://erich-friedman.github.io/packing/octintri/index.html

---

Dear Dr. Friedman,

This is Luke Kaiser. We have found improved packing configurations for **octintri** (8 in 3):
...
| :---: | :---: | :---: | :---: | :---: | :---: |
| 6 | 9.31578+ | 9.315779776455 | 9.31580+ | -0.000020 | `6.png` |

### Image Attachments
The replacement image files are attached directly with exact matching colors (#feffe9 on #ffffff), orientation, no borders or text, and target website pixel dimensions (260x225 px):
- `6.png`
